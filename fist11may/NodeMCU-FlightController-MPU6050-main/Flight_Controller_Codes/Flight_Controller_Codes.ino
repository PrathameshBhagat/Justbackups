...
Serial.print(packet[0]);Serial.print(packet[1]);Serial.print(packet[2]);Serial.print(packet[3]);
Serial.print(packet[5]);Serial.print(packet[6]);Serial.print(packet[7]);Serial.print("ROLL: ");
...
Serial.println();*/
if(i){Serial.println("Started");i=!i;}
} 
