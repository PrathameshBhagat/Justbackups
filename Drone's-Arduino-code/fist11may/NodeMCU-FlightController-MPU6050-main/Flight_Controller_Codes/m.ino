...
Serial.begin(115200);
WiFi.mode(WIFI_STA);
WiFi.begin("realme 9 Pro+", "111111111");
...
Serial.print("ROLL: ");Serial.print(input_ROLL);Serial.print(" ");
Serial.print("Throttle: "); Serial.print(input_THROTTLE);Serial.print(" ");
Serial.print("YAW: "); Serial.print(input_YAW);Serial.print(" ");
Serial.print("twoX_kp: ");Serial.print(twoX_kp);Serial.print(" ");
Serial.print("twoX_ki: ");Serial.print(twoX_ki);Serial.print(" ");
Serial.print("twoX_kd: ");Serial.print(twoX_kd);Serial.println();
if(r){
Serial.println("Started");r=!r;}
} 
